...
// create a new AlertSourceServiceDeleteInput by passing an ID string
func NewAlertSourceServiceDeleteInput(value string) *AlertSourceServiceDeleteInput {
	return &AlertSourceServiceDeleteInput{
		Id: *NewID(value),
	}
}
...
// create a new ContactDeleteInput by passing an ID string
func NewContactDeleteInput(value string) *ContactDeleteInput {
	return &ContactDeleteInput{
		Id: *NewID(value),
	}
}
...
// create a new ServiceDeleteInput by passing an ID or alias string
func NewServiceDeleteInput(value string) *ServiceDeleteInput {
	if IsID(value) {
...
// create a new TagDeleteInput by passing an ID string
...
// create a new ToolDeleteInput by passing an ID string
func NewToolDeleteInput(value string) *ToolDeleteInput {
	return &ToolDeleteInput{
		Id: *NewID(value),
	}
}
