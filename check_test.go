...
func BuildCheckMutation(name string, style RequestStyle) string {
  ...
  check[% .Name %][% .Style %](input: $input){
    check{
      ...
      ... on ServicePropertyCheck{serviceProperty,propertyDefinition{id,alias},propertyValuePredicate{type,value}},
